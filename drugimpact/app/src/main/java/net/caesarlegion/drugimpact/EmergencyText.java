...
public class EmergencyText extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            //Here we create the new intent, in this case, the
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("sms:555-555-5555"));
            intent.putExtra("sms_body", "Emergency");
